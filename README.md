...
夜深人靜，當同學們沉浸在短影音和遊戲（我為Linux開發，早已和遊戲絕緣）的世界時，我卻爆肝到午夜，早上八點準時起床。這感覺比上學還要累，但卻是我選擇的路。陪伴我的，只有鍵盤的敲擊聲、電腦螢幕的微光，以及泡麵（偶爾奢侈地拌上松露醬和品客碎屑）的香氣。我用盡所有的課餘時間與零用錢（總共2000元，扣掉cursor
還剩一些），傾盡心血，打造出這個我稱之為「MTC（大師工具組合）C2」的專案。它不是什麼高大上的「網路基地」，而是我獨有的「網路堡壘」。
